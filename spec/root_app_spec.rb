describe RootApp do
  ...
  context "when GET / route called." do
    before do
      get "/"
    end
  ...
  context "when GET /ping.json route called." do
    before do
      get "/ping.json"
    end
  ...
  context "when GET /security.txt route called." do
    before do
      get "/security.txt"
    end
  ...
  context "when GET /.well-known/security.txt route called." do
    before do
